...
load = { '1' : ['1221377349400','122.13.77.34','765'], 
         ...
         '5' : ['1221377349400','122.13.77.34','777'],
         '6' : ['12213771779400','122.13.77.177','776'], 
        } 
...
def insertnewstg(cid, load_id):
    insert_load1_sql = '''
        ...
        VALUES 
            ('1221377349400', '122.13.77.34', 'qqdomain', '765', '%s', '%s', 0, 'ByGroup', 12, 30, 1, '2013-03-22 16:28:00', NULL, NULL);
    '''
    insert_load2_sql = '''
        INSERT INTO `strategy` 
            (`server_id`, `server_ip`, `domain_key`, `resource_ids`, `owner_type`, `owner_value`, `for_test_msg`, `switch_type`, `switch_value`, `init_group_size`, `min_group_size`, `last_update_time`, `from_domains`, `remark`) 
        VALUES 
            ('1221377349400', '122.13.77.34', 'qqdomain', '747', '%s', '%s', 0, 'ByGroup', 12, 30, 1, '2013-03-22 16:28:00', NULL, NULL);
    '''
    insert_load3_sql = '''
        INSERT INTO `strategy` 
            (`server_id`, `server_ip`, `domain_key`, `resource_ids`, `owner_type`, `owner_value`, `for_test_msg`, `switch_type`, `switch_value`, `init_group_size`, `min_group_size`, `last_update_time`, `from_domains`, `remark`) 
        VALUES 
            ('12213771779400', '122.13.77.177', 'qqdomain', '764', '%s', '%s', 0, 'ByGroup', 12, 28, 1, '2013-03-22 16:28:00', NULL, NULL);
    '''
    insert_load4_sql = '''
        INSERT INTO `strategy` 
            (`server_id`, `server_ip`, `domain_key`, `resource_ids`, `owner_type`, `owner_value`, `for_test_msg`, `switch_type`, `switch_value`, `init_group_size`, `min_group_size`, `last_update_time`, `from_domains`, `remark`) 
        VALUES 
            ('1221377349400', '122.13.77.34', 'qqdomain', '756', '%s', '%s', 0, 'ByGroup', 12, 30, 1, '2013-03-22 16:28:00', NULL, NULL);
    '''
    insert_load5_sql = '''
        INSERT INTO `strategy` 
            (`server_id`, `server_ip`, `domain_key`, `resource_ids`, `owner_type`, `owner_value`, `for_test_msg`, `switch_type`, `switch_value`, `init_group_size`, `min_group_size`, `last_update_time`, `from_domains`, `remark`) 
        VALUES 
            ('1221377349400', '122.13.77.34', 'qqdomain', '777', '%s', '%s', 0, 'ByGroup', 12, 16, 1, '2013-03-22 16:28:00', NULL, NULL);
    '''
    insert_load6_sql = '''
        INSERT INTO `strategy` 
            (`server_id`, `server_ip`, `domain_key`, `resource_ids`, `owner_type`, `owner_value`, `for_test_msg`, `switch_type`, `switch_value`, `init_group_size`, `min_group_size`, `last_update_time`, `from_domains`, `remark`) 
        VALUES 
            ('12213771779400', '122.13.77.177', 'qqdomain', '776', '%s', '%s', 0, 'ByGroup', 12, 15, 1, '2013-03-22 16:28:00', NULL, NULL);
    '''
    sql_dict = { "1": insert_load1_sql, "2": insert_load2_sql, "3": insert_load3_sql, "4": insert_load4_sql, "5": insert_load5_sql, "6": insert_load6_sql}
    ...
    try:
        resource_conn = mdb.get_resource_conn()
        row_info = mdb.exe_update_sql(resource_conn, sql % (owner_type, cid), False, True, False, False)
        print row_info
    except Exception,e:
        print e
        sys.exit()
